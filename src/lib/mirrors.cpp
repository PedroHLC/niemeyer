...
MirrorEntry::MirrorEntry(QString nurl, QObject *parent)
    : QObject(parent), url(nurl), enabled(true) {}

QString MirrorEntry::getURL() { return url; }
bool MirrorEntry::isEnabled() { return enabled; }
...
void Mirrors::setEnabled(int i, bool en) { mirrorsList.at(i)->setEnabled(en); }

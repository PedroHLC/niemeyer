...
class Network : public QObject {
  ...
  Q_PROPERTY(QString wifiPassword READ getWifiPassword WRITE setWifiPassword
                 NOTIFY wifiPasswordChanged)
  Q_PROPERTY(QString wifiProfile READ getWifiProfile WRITE setWifiProfile NOTIFY
                 wifiProfileChanged)
  Q_PROPERTY(QString ethProfile READ getEthProfile WRITE setEthProfile NOTIFY
                 ethProfileChanged)

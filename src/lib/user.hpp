...
class User : public QObject {
  ...
  Q_PROPERTY(QString userPasswordConfirm READ getUserPasswordConfirm WRITE
                 setUserPasswordConfirm)
  Q_PROPERTY(QString rootPassword READ getRootPassword WRITE setRootPassword)
  Q_PROPERTY(QString rootPasswordConfirm READ getRootPasswordConfirm WRITE
...
private:
  ...
  void validatePasswords(QString errorMessage, QString password,

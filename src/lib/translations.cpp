...
Translations::Translations(QGuiApplication *app, QQmlEngine *engine,
                           QObject *parent)
...
void Translations::setLang(QString locale) {
  QString path = QStringLiteral("../" LANGS_PATH "%1.qm").arg(locale);
...
QString Translations::getLang() { return selectedLang; }
